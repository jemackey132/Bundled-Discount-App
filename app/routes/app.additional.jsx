            ...
            <Layout>
              <Layout.Section>
                      ...
                      <HorizontalStack wrap={false}>
                        <VerticalStack>
                          ...
                          <p className="callout-description">
                            Want to boost your success? Learn about Fast Bundle
                            and product bundling on Shopify, with answers to
                            common questions. Stay tuned for updates!
                          </p>
                              ...
                              <div>
                                <HorizontalStack wrap={false} gap="1">
                                  ...
                                  <Popover
                                    ...
                                    autofocusTarget="first-node"
                                    onClose={() => toggleActive("active_three")}
                                  >
                                    <ActionList
                                      actionRole="menuitem"
                                      items={[
                  ...
                  <VerticalStack gap="2">
                    <Card>
                      ...
                      <div className="design-card-subtitle">
                        <Text as="p" variant="bodyMd">
                          You can customize different design types of bundles in different
                          displays and change the colors, typography and other items in
                          accordance with your shop design.
                        </Text>
                      </div>
                    ...
                    <VerticalStack gap="4">
                      <VerticalStack gap="2">
                        ...
                        <Text as="p" variant="bodyMd">
                          Customize the order of the bundles on the Product Page and Bundles
                          Page according to the bundles priority.
                        </Text>
                      </VerticalStack>
                      <HorizontalGrid columns={2} gap="8">
                        <Card>
                          ...
                          <div className="design-card-subtitle">
                            <Text as="p" variant="bodySm">
                              Customize the priority of the bundles displayed on the bundles
                              page, and you can display important bundles at the top of the
                              screen.
                            </Text>
                          </div>
                          <div
                        ...
                        <Card>
                          ...
                          <div className="design-card-subtitle">
                            <Text as="p" variant="bodySm">
                              From the list of products that have bundles, select the
                              product you want and customize the priority in which the
                              bundles are displayed on the page of that product.
                            </Text>
                          </div>
                          <div style={{ display: "flex", justifyContent: "end",
                              marginTop: "7px" }}>
                ...
                {selected == 4 && (
                  ...
                  <Grid gap={{ 'xs': '20px', 'sm': '20px', 'md': '20px', 'lg': '20px', 'xl': '20px' }} columns={{ xs: 1, sm: 2, md: 2, lg: 2, xl: 2 }}>
                    <Grid.Cell>
                      <div className="settingtab-card">
                        <Link onClick={() => cnav("app/bundle_settings")}  removeUnderline={true}>
                          <Card>
                            <HorizontalStack wrap={false} gap="5">
                              <Avatar shape="square" customer name="Farrah" />
                              <VerticalStack>
                                <Text as="h2" variant="headingMd">
                                  Bundle settings
                                </Text>
                                <Text as="p" variant="bodyMd">
                                  Manage settings about bundle inventory, button, discount and
                                  pricing
                                </Text>
                              </VerticalStack>
                            </HorizontalStack>
                          ...
                          <Card>
                            <HorizontalStack wrap={false} gap="5">
                              ...
                              <VerticalStack>
                                ...
                                <Text as="p" variant="bodyMd">
                                Translate the bundles’ content to your shop’s language
                                </Text>
                              </VerticalStack>
                            </HorizontalStack>
                          </Card>
                          ...
                          <Card>
                            <HorizontalStack wrap={false} gap="5">
                              ...
                              <VerticalStack>
                                ...
                                <Text as="p" variant="bodyMd">
                                Grow your business with a handpicked collection of apps
                                </Text>
                              </VerticalStack>
                            </HorizontalStack>
                          </Card>
                    ...
                    <Modal.Section>
                      <div className="bundle-popup">
                        <Grid>
                          ...
                          >
                            <Link onClick={() => cnav("app/create_bundle_form")}  removeUnderline={true}>
                              <VerticalStack gap="2">
                                <HorizontalStack
                                  wrap={false}
                                  align="space-between"
                            ...
                            <Link removeUnderline={true}>
                              <VerticalStack gap="2">
                                ...
                                >
                                  <div className="bundle-popup-button-footer-text">
                                    <Text variant="bodySm" as="p">
                                      Example: BOGO, Buy 3 items of X to get 20%
                                      off.
                                    </Text>
                                  </div>
                                </Card>
                            ...
                            <Link removeUnderline={true}>
                              <VerticalStack gap="2">
                                  ...
                                  <VerticalStack inlineAlign="start">
                                    ...
                                    <div className="bundle-popup-button-subtext">
                                      <Text
                                        ...
                                        alignment="start"
                                      >
                                        Offer a discount when a customer buys at
                                        least a specific number of items from a
                                        group of products. (Combo product option
                                        is available)
                                      </Text>
                                    </div>
                                  </VerticalStack>
                                ...
                                >
                                  <div className="bundle-popup-button-footer-text">
                                    <Text variant="bodySm" as="p">
                                      Example: Buy at least 2 items from X, Y, Z
                                      to get 20% off.
                                    </Text>
                                  </div>
                                </Card>
                            ...
                            <Link removeUnderline={true}>
                              <VerticalStack gap="2">
                                ...
                                >
                                  <div className="bundle-popup-button-footer-text">
                                    <Text variant="bodySm" as="p">
                                      Example: Buy 4 items from collection X and
                                      2 from collection Y to get $30 off.
                                    </Text>
                                  </div>
                                </Card>
                              </VerticalStack>
                            ...
                            <Link removeUnderline={true}>
                              <VerticalStack gap="2">
                                  ...
                                  <VerticalStack inlineAlign="start">
                                    ...
                                    <div className="bundle-popup-button-subtext">
                                      ...
                                      >
                                        ...
                                        product(s) when a customer buys specific
                                        product(s).
                                      </Text>
                                    </div>
                                  </VerticalStack>
                                ...
                                >
                                  <div className="bundle-popup-button-footer-text">
                                    <Text variant="bodySm" as="p">
                                      Example: Buy X and get Y for free or Buy X
                                      and get Y with 20% off.
                                    </Text>
                                  </div>
                                </Card>
                              </VerticalStack>
                                  ...
                                  <VerticalStack inlineAlign="start">
                                    ...
                                    <div className="bundle-popup-button-subtext">
                                      ...
                                      >
                                        ...
                                        bought alongside a specific product like
                                        Amazon (with or without a discount).
                                      </Text>
                                    </div>
                                  </VerticalStack>
                                </HorizontalStack>
